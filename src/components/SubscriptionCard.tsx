  ...
  return (
    <>
      <article
        ...
        className={`border border-border rounded-lg p-4 max-w-lg overflow-hidden bg-bg2  transition-transform duration-300 ease-in-out hover:translate-y-2   border-2 shadow-inner`}
      >
